...
namespace FitnessProject.Components
{
    public partial class CtrlMoneyMovement : UserControl
    {
        ...
        public CtrlMoneyMovement()
        {
            ...
            var user = (DBLayer.Users.Details) AppDomain.CurrentDomain.GetData("User");

            if (!user.IsAdmin)
            {
                tbDateFrom.Text = DateTime.Now.Date.ToShortDateString();
                tbDateTill.Text = DateTime.Now.Date.ToShortDateString();

                tbtnChoose.Enabled = false;
                tbtnDateFrom.Enabled = false;
                tbtnDateTill.Enabled = false;
                tbtnToday.Enabled = false;
                tbtnMonth.Enabled = false;
            }
