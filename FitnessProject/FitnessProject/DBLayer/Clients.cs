...
namespace FitnessProject.DBLayer
{
    public class Clients
    {
        ...
        public static int Insert(DBLayer.Clients.Details det)
        {
            ...
            sql += " VALUES (" + det.DocumentId.ToString() + ", " + det.TypeId.ToString() + ", " + det.SourceId.ToString() + ", '" + det.FIO + "', '" + det.Barcode + "', '" + det.RegisterDate.ToString("MM/dd/yyyy") + "', '" + det.BirthDate.ToString("MM/dd/yyyy") + "', '" + det.DocumentNumber + "', '" + det.Phone + "', " + det.Sex.ToString() + ")";
        ...
        public static void Update(DBLayer.Clients.Details det)
        {
            ...
            ZFort.DB.Execute.ExecuteString_void("UPDATE Clients SET [RegisterDate] = '" + det.RegisterDate.ToString("MM/dd/yyyy") + "' WHERE [Id] = " + det.Id.ToString());

            ZFort.DB.Execute.ExecuteString_void("UPDATE Clients SET [BirthDate] = '" + det.BirthDate.ToString("MM/dd/yyyy") + "' WHERE [Id] = " + det.Id.ToString());
        ...
        {
            string sql = "SELECT FIO, BirthDate, Phone FROM Clients ";
