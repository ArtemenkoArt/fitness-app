...
namespace FitnessProject.DBLayer
{
    public class Abonements
    {
        ...
        {
            string sql = "SELECT a.*, c.[Name] AS CoachName FROM Abonements AS a LEFT JOIN Coaches AS c ON c.Id = a.CoachId";
        ...
        {
            ZFort.DB.Execute.ExecuteString_void("INSERT INTO Abonements ([Name], [Length], [Cost], AbonementGroup, LessonsCount, IsSingle, IsUnlim, [Time], CoachId, Weekdays, AdditionalVisits) VALUES ('" + det.Name + "', " + det.Length.ToString().Replace(",", ".") + ", " + det.Cost.ToString().Replace(",", ".") + ", " + det.AbonementGroup.ToString() + ", " + det.LessonsCount.ToString() + ", " + Convert.ToInt32(det.IsSingle).ToString() + ", " + Convert.ToInt32(det.IsUnlim).ToString() + ", '" + det.Time + "', " + det.CoachId.ToString() + ", '" + det.Weekdays + "', " + det.AdditionalVisits.ToString() + ")");
        ...
        {
            ZFort.DB.Execute.ExecuteString_void("DELETE FROM Abonements WHERE [Id] = " + id.ToString());
        }
