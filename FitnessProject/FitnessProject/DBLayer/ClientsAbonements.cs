...
namespace FitnessProject.DBLayer
{
    public class ClientsAbonements
    {
        ...
        public static int Insert(DBLayer.ClientsAbonements.Details det)
        {
            ...
            sql += " VALUES (" + det.ClientId.ToString() + ", " + det.AbonementId.ToString() + ", '" + det.DateStart.ToString("yyyyMMdd") + "', '" + det.DateFinish.ToString("yyyyMMdd") + "', 1, " + det.VisitsCount.ToString() + ", " + det.AdditionalCount.ToString() + ", " + det.CoachId.ToString() + ", '" + det.Weekdays + "', '" + det.Time + "')";
