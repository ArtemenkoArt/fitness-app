...
namespace FitnessProject.DBLayer
{
    public class Coaches
    {
        ...
        {
            DataTable dt = ZFort.DB.Execute.ExecuteString_DataTable("SELECT * FROM Coaches");
        ...
        {
            DataTable dt = ZFort.DB.Execute.ExecuteString_DataTable("SELECT * FROM Coaches WHERE Type IS NULL OR Type = " + type.ToString());
